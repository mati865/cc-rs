...
## [1.2.2](https://github.com/mati865/cc-rs/compare/cc-v1.2.1...cc-v1.2.2) - 2024-11-29

### Other

- Regenerate target info ([#1301](https://github.com/mati865/cc-rs/pull/1301))
- Fix compilation of C++ code for armv7-unknown-linux-gnueabihf ([#1298](https://github.com/mati865/cc-rs/pull/1298))
- Fetch target info from Cargo even if `Build::target` is manually set ([#1299](https://github.com/mati865/cc-rs/pull/1299))
- Fix two files with different extensions having the same object name ([#1295](https://github.com/mati865/cc-rs/pull/1295))
- Allow disabling cc's ability to compile via env var CC_FORCE_DISABLE ([#1292](https://github.com/mati865/cc-rs/pull/1292))
- Regenerate target info ([#1293](https://github.com/mati865/cc-rs/pull/1293))
